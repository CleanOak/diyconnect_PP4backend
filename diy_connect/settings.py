"""
Django settings for diy_connect project.
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION': [(
        'rest_framework.authentication.SessionAuthenticatioin'
...
SECRET_KEY = 'django-insecure-&4@l^l$onwu%ejp@11#lkeii=7ov@ie(i+!pyvk436y)9%8r#4'
...
WSGI_APPLICATION = 'diy_connect.wsgi.application'
